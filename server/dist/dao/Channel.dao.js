...
class ChannelDao {
    async create(data, options) {
        return Channel_model_1.default.create(data, options);
    }
    async findByPk(id, options) {
        return Channel_model_1.default.findByPk(id, options);
    }
    async findOne(options) {
        return Channel_model_1.default.findOne(options);
    }
    async findAll(options) {
        return Channel_model_1.default.findAll(options);
    }
    async findAndCountAll(options) {
        return Channel_model_1.default.findAndCountAll(options);
    }
    async update(data, options) {
        return Channel_model_1.default.update(data, options);
    }
    async destroy(options) {
        return Channel_model_1.default.destroy(options);
    }
    async count(options) {
        return Channel_model_1.default.count(options);
    }
    async findById(id) {
...
exports.default = new ChannelDao();
