...
router.post('/', controllers_1.permissionController.create);
router.get('/tree', controllers_1.permissionController.findTree);
router.get('/:id', controllers_1.permissionController.findById);
router.put('/:id', controllers_1.permissionController.update);
router.delete('/:id', controllers_1.permissionController.delete);
