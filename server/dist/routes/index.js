...
const promoter_audit_routes_1 = __importDefault(require("./promoter-audit.routes"));
const promoter_manage_routes_1 = __importDefault(require("./promoter-manage.routes"));
const promoter_level_routes_1 = __importDefault(require("./promoter-level.routes"));
const promoter_risk_routes_1 = __importDefault(require("./promoter-risk.routes"));
...
router.use('/promoter-audits', promoter_audit_routes_1.default);
router.use('/promoter-manage', promoter_manage_routes_1.default);
router.use('/promoter-levels', promoter_level_routes_1.default);
router.use('/promoter-risk', promoter_risk_routes_1.default);
