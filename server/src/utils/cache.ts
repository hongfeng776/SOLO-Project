...
export enum CacheKey {
  ...
  ACTIVITY_PARTICIPATION_STATS = 'activity:participation:stats:',
  ACTIVITY_PARTICIPATION_LOCK = 'activity:participation:lock:',
  REWARD_WRITE_OFF = 'reward:writeoff:',
  REWARD_WRITE_OFF_STATS = 'reward:writeoff:stats:',
  REWARD_WRITE_OFF_LOCK = 'reward:writeoff:lock:',
