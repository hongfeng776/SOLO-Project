...
export const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'hotel-room-manage',
        name: 'HotelRoomManage',
        component: () => import('@/views/hotel/HotelRoomManage.vue'),
      ...
      {
        path: 'ticket-inventory-ops',
        name: 'TicketInventoryOps',
        component: () => import('@/views/ticket-inventory/TicketInventoryOps.vue'),
