...
import messageDeliveryRoutes from './message-delivery.routes';
import messagePermissionRoutes from './message-permission.routes';
...
router.use('/message-deliveries', messageDeliveryRoutes);
router.use('/message-permissions', messagePermissionRoutes);
