...
class NoteOpsAbnormalLog extends Model<InferAttributes<NoteOpsAbnormalLog>, InferCreationAttributes<NoteOpsAbnormalLog>> {
  declare id: CreationOptional<number>
  declare opsLogId: number
...
NoteOpsAbnormalLog.init(
  ...
  {
    sequelize,
    tableName: 'biz_note_ops_abnormal_log',
    modelName: 'NoteOpsAbnormalLog',
    indexes: [
      { fields: ['ops_log_id'], unique: true },
...
export default NoteOpsAbnormalLog
