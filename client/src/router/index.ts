  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import(/* @vite-ignore *//* webpackChunkName: "trade" */ '@views/stock-classification/index.vue'),
        meta: { title: '股票分类管理', icon: 'Menu', keepAlive: true }
      },
      {
        path: 'stock-fee-rate',
        name: 'StockFeeRate',
        component: () => import(/* @vite-ignore *//* webpackChunkName: "trade" */ '@views/stock-fee-rate/index.vue'),
      ...
      },
      {
        ...
        component: () => import(/* @vite-ignore *//* webpackChunkName: "trade" */ '@views/business-inspection/index.vue'),
        meta: { title: '业务合规巡检', icon: 'DataLine', keepAlive: false, permission: 'compliance:view' }
      },
      {
        path: 'system/user',
        name: 'SystemUser',
